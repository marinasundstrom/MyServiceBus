...
- Prioritized a Dashboard workflow-run drill-down for the choreography MVP: a monitoring-owned bounded causal reconstruction presented as a flow diagram and ordered step breakdown, with application and consumer mapping, separate handler and transit duration, emitted messages, retries, and localized failures. The design keeps reconstructed choreography evidence distinct from an authoritative saga instance.
