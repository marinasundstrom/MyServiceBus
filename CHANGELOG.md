...
- Added the first Kotlin-native JVM facade with a Kotlin-owned configuration DSL, reified consumer and transport registration, typed dependency-injection helpers, coroutine-awaitable messaging operations, and suspending consumers with inferred message types and bidirectional cancellation. A runnable RabbitMQ sample, focused Kotlin tests, staged package consumer, Maven publication wiring, and three-language website samples establish the compatibility path for future KSP support.
