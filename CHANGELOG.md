...
- Added the first Kotlin-native JVM facade with extension-based bus composition, reified consumer and transport registration, and typed dependency-injection helpers. A runnable RabbitMQ sample, focused Kotlin tests, staged package consumer, Maven publication wiring, and three-language website samples establish the compatibility path for future coroutine and KSP support.
