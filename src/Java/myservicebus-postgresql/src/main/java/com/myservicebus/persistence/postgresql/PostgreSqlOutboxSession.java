...
public final class PostgreSqlOutboxSession {
     ...
     */
    public static OutboxSession.Registration useTransaction(OutboxSession session, Connection connection) {
        Objects.requireNonNull(session, "session");
        return session.begin(new PostgreSqlOutboxWriter(connection));
    }
}
