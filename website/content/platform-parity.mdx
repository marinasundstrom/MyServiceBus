...
<p className="docs-summary">Start with the developer capability, then compare the C# and Java entry points, the alignment choice, the evidence behind it, and the remaining compatibility risk. Similar means recognizable contract and behavior—not an unversioned promise of source or database compatibility.</p>
