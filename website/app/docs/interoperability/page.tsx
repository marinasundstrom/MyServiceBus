...
export default function Interoperability() {
  return (
    <article className="docs-article">
      ...
      <p className="docs-summary">MyServiceBus compatibility is deliberately scoped by transport. The verified RabbitMQ and Azure Service Bus preview baselines cover portable messaging across the C# client, Java client, and MassTransit.</p>
      ...
      <div className="version-table" role="table" aria-label="Supported baseline">
        <div role="row"><span role="cell">MyServiceBus</span><strong role="cell">0.1.0-preview.4</strong></div>
