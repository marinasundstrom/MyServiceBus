...
export default function Interoperability() {
  return (
    <article className="docs-article">
      ...
      <div className="callout"><strong>Azure Service Bus: experimental</strong><p>Live Azure verifies cloud topology, default message-topic naming, and bidirectional publish between MassTransit and both MyServiceBus clients. Default endpoint naming plus directed send, request, response, and fault interoperability remain release gates.</p></div>
