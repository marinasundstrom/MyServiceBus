...
if [ "$require_signatures" = "1" ]; then
  echo "Verified eleven signed Maven publications with binary, source, Javadoc, module, and POM artifacts for $version."
else
  echo "Verified eleven Maven publications with binary, source, Javadoc, module, and POM artifacts for $version."
fi
