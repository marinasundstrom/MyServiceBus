...
public class GeneratedConsumerRegistrationTests
{
    ...
    public void Generated_catalog_registers_typed_consumer_descriptors()
    {
        ...
        Assert.Equal(
            ["__MethodConsumer0", "__MethodConsumer1", "__MethodConsumer2", "__MethodConsumer3", "__MethodConsumer4", "__MethodConsumer5", "FulfillmentCompletedConsumer", "FulfillmentRequestedConsumer", "InventoryCheckRequestedConsumer", "InventoryReservedConsumer", "OrchestrationPaymentRequestedConsumer", "OrderOrchestrationCompletedConsumer", "OrderSubmittedConsumer", "ParallelOrderChecksRequestedConsumer", "PaymentCheckRequestedConsumer", "SubmitOrderConsumer", "SubmitOrderFaultConsumer", "TestRequestConsumer"],
