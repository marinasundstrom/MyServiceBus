...
| Explicit serializer factory | Implemented with service-provider factory | Not required | Implemented for serializer and deserializer | Not required |
...
| Source-generated JSON metadata | Application-configured opt-in | Not owned by consumer generator | Serializer-specific | Not owned by consumer processor |
