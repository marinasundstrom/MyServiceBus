...
The current release work follows the [Enterprise Production Readiness](../enterprise-readiness.md) plan. Preview `0.1.0-preview.8` adds experimental Amazon SQS/SNS clients, broader Azure Service Bus emulator interoperability evidence, and experimental .NET 11 union semantics with idiomatic Raven consumption. These additions retain their documented experimental boundaries and do not expand the foundation MVP's production-readiness claim.
